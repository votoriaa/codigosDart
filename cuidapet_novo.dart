      ...
      switch (opcao) {
        case '1':
          ...
          if (carrinho.length < 3) {
            switch (codigo) {
              case '101':
                carrinho.add("Ração Royal Canin Indoor Para Cães Adultos De Porte Mini De Ambientes Internos 7,5kg");
                preco.add(290.00);
                print("Produto adicionado.");
                break;
              case '102':
                carrinho.add("Ração Royal Canin Sterilised para Gatos Adultos Castrados");
                preco.add(492.00);
                print("Produto adicionado.");
                break;
              case '103':
                carrinho.add("Bifinho Keldog para Cães Porte Pequeno Sabor Carne");
                preco.add(23.92);
                print("Produto adicionado.");
                break;
              case '104':
                carrinho.add("Fraldas Descartáveis Super Secão para Cães Machos");
                preco.add(38.61);
                print("Produto adicionado.");
                break;
              default:
